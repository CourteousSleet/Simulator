    ...
    def DeleteItemFunction(self):
        ...
        if os.path.exists(Filepath):
            ...
            if('Космический' in item.split(' ')[1]):
                ...
                plSystem.space_bodies.pop(currentIndex)
    ...
    def SaveChanges(self):
        ...
        if os.path.exists(Filepath):
            ...
            if('Космический' in item.split(' ')[1]):
                ...
                plSystem.space_bodies[currentIndex].x0 = float(self.x0_field.text())
                plSystem.space_bodies[currentIndex].y0 = float(self.y0_field.text())
                plSystem.space_bodies[currentIndex].Vx0 = float(self.Vx0_field.text())
                plSystem.space_bodies[currentIndex].Vy0 = float(self.Vy0_field.text())
                plSystem.space_bodies[currentIndex].m = float(self.M_field.text())
                plSystem.space_bodies[currentIndex].R = float(self.R_field.text())
                plSystem.space_bodies[currentIndex].color = [float(i) for i in self.Color_field.text().split(', ')]
            ...
            objects = []
            for planet in plSystem.space_bodies:
